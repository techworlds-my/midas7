        ...
        <form method="POST" action="{{ route("admin.item-managements.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_veg') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="is_veg" id="is_veg" value="1" required {{ old('is_veg', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_halal') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="is_halal" id="is_halal" value="1" required {{ old('is_halal', 0) == 1 ? 'checked' : '' }}>
